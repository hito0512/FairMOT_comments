...
def main(opt):
    ...
    dataset = Dataset(opt, dataset_root, trainset_paths, (640, 480), augment=True, transforms=transforms)
    ...
    warmup_epoch = 5
    lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, float(opt.num_epochs - warmup_epoch))
